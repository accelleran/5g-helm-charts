...
{{- else }}
{{- required "The Instance ID you have chosen is invalid! The Instance ID must consist of lower case alphanumeric characters or '-', start with an alphabetic character, and end with an alphanumeric character (e.g. 'my-name',  or 'abc-123', regex used for validation is '^[a-z]([a-z0-9-]*[a-z0-9])?$'). The Instance ID also cannot be longer than 7 alphanumeric characters!" nil }}
{{- end }}
{{- end }}
...
{{- else }}
{{- required "The Instance ID you have chosen is invalid! The Instance ID cannot be longer than 7 alphanumeric characters!" nil }}
{{- end }}
{{- end }}
