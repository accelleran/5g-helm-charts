...
*/}}
{{- define "acc-5g-cell-wrapper.name" -}}
...
*/}}
{{- define "acc-5g-cell-wrapper.fullname" -}}
...
*/}}
{{- define "acc-5g-cell-wrapper.chart" -}}
...
Common labels
*/}}
{{- define "acc-5g-cell-wrapper.labels" -}}
helm.sh/chart: {{ include "acc-5g-cell-wrapper.chart" . }}
{{ include "acc-5g-cell-wrapper.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "acc-5g-cell-wrapper.selectorLabels" -}}
app.kubernetes.io/name: {{ include "acc-5g-cell-wrapper.name" . }}
...
*/}}
{{- define "acc-5g-cell-wrapper.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "acc-5g-cell-wrapper.fullname" .) .Values.serviceAccount.name }}
{{- else }}
